MDK-Middleware: FTP Server example
==================================

This application demonstrates the use of an FTP server, developed with MDK-Middleware.

Detailed description is available in the [*MDK-Middleware Network Component documentation*](https://www.keil.com/pack/doc/MW/Network/html/_f_t_p__server__example.html).
