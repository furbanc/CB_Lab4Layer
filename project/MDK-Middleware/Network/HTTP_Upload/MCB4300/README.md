MDK-Middleware: HTTP Upload example
===================================

This application demonstrates the file upload of an HTTP server, developed with MDK-Middleware.

Detailed description is available in the [*MDK-Middleware Network Component documentation*](https://www.keil.com/pack/doc/MW/Network/html/_h_t_t_p__upload__example.html).
