MDK-Middleware: Telnet Server example
=====================================

This application demonstrates the use of a Telnet server, developed with MDK-Middleware.

Detailed description is available in the [*MDK-Middleware Network Component documentation*](https://www.keil.com/pack/doc/MW/Network/html/_telnet__example.html).
